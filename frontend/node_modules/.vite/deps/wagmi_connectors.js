...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-U2P7QF6E.js";
import "./chunk-KTW2PGTC.js";
import "./chunk-KFYLNAUR.js";
...
import {
  ...
  injected,
  mock
} from "./chunk-XAUUVN77.js";
import "./chunk-EDDRWZDP.js";
import {
  import_index
} from "./chunk-FFEVG7EM.js";
import "./chunk-LWLUVSGB.js";
import {
  withRetry,
  withTimeout
} from "./chunk-VN7IKUU7.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-PVYCHUE5.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-GKOA54HZ.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-FGSDYOVI.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-5Q7F3S7F.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-5ECSM4KF.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-OQYK6NEM.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-RTF4HGV2.js");
